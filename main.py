...
async def start(client: Client, msg: Message):
    ...
    await start_message.edit_text(
        Data.START.format(msg.from_user.mention) +
        "Checking status Ok... Command Nhi Bataunga **Made BY ANAJAN PERSON™\n\n"
        "Progress:[🟩🟩🟩🟩🟩🟩🟩🟩🟩] 100%\n\n"
    )
...
async def restart_handler(_, m):
    await m.delete()
    await m.reply_text("**BOT IS STOPPED**🛑", True)
        ...
        for i in range(arg-1, len(links)):
            ...
            if 'd1d34p8vz63oiq' in url:
               ...
               # url = f"https://dragoapi.vercel.app/video/{url}"
                ...
                url = f"https://cpapi-ytas.onrender.com/extract_keys?url={url}@bots_updatee&user_id=2073438175"
                ...
                signed_api = f"https://cpapi-ytas.onrender.com/extract_keys?url={url}@bots_updatee&user_id=2073438175"
